...
export default function ReorderPagesPage() {
  ...
  const handleReorder = async () => {
    ...
    if (selectedPages.length === 0) {
      setError("Please select the new order of pages.")
      return
    }
    ...
    try {
      ...
      // 2. Reorder pages
      const processRes = await fetch("/api/tools/reorder", {
        method: "POST",
      ...
      if (!processRes.ok) {
        throw new Error(processData.error || "Reorder failed")
      }
      ...
      <div className="bg-surface-container p-8 rounded-xl border border-outline-variant max-w-4xl mx-auto">
        {result ? (
          <div className="text-center py-8">
            ...
            <h1 className="font-display-lg text-display-lg mb-2">Pages Reordered Successfully!</h1>
          ...
          <>
            <div className="text-center mb-8">
              ...
              <h1 className="font-display-lg text-display-lg">Reorder Pages</h1>
              <p className="text-on-surface-variant font-body-md mt-2">Select pages in the exact order you want them to appear.</p>
            </div>
            ...
            {!file ? (
              ...
              <div className="mt-8">
                ...
                <button 
                  ...
                  disabled={uploading || processing || selectedPages.length === 0}
                ...
                >
                  {uploading ? "Uploading..." : processing ? "Processing..." : `Reorder ${selectedPages.length} Pages`}
                </button>
              </div>
            )}
          </>
